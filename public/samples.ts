import fdc3AppSchema from "./examples/fdc3-application-2.1/schema.json" 
import fdc3AppUiSchema from "./examples/fdc3-application-2.1/uischema.json" 
import fdc3AppData from "./examples/fdc3-application-2.1/data.json" 

export let samples: any = [];
console.log("Here")

samples.push({
  name: 'fdc3-application-2.1',
  label: 'FDC3 Application (2.1)',
  schema: fdc3AppSchema,
  uischema: fdc3AppUiSchema,
  data: fdc3AppData
})
